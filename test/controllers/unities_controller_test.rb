...
class UnitiesControllerTest < ActionController::TestCase
  ...
  test "should create unity" do
    assert_difference('Unity.count') do
      post :create, unity: { description: @unity.description, name: @unity.name, section_id: @unity.section_id }
    end
  ...
  test "should update unity" do
    patch :update, id: @unity, unity: { description: @unity.description, name: @unity.name, section_id: @unity.section_id }
    assert_redirected_to unity_path(assigns(:unity))
  end
